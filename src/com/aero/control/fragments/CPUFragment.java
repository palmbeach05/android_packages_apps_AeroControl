...
public class CPUFragment extends PlaceHolderFragment {
    ...
    public final void onCreate(Bundle savedInstanceState) {
        ...
        this.mMaxFrequency.setTitle(R.string.pref_max_freq_cpu);
        this.mMaxFrequency.setDialogTitle(R.string.pref_max_freq_cpu);
        this.mMaxFrequency.setSummary(R.string.pref_max_freq_cpu);
        ...
        this.mMinFrequency.setTitle(R.string.pref_min_freq_cpu);
        this.mMinFrequency.setDialogTitle(R.string.pref_min_freq_cpu);
        this.mMinFrequency.setSummary(R.string.pref_min_freq_cpu);
        ...
        if (mNumCpus > 4) {
            ...
            this.mBIGMaxFrequency.setTitle(R.string.pref_max_freq_cpu_big);
            this.mBIGMaxFrequency.setDialogTitle(R.string.pref_max_freq_cpu_big);
            this.mBIGMaxFrequency.setSummary(R.string.pref_max_freq_cpu_big);
            ...
            this.mBIGMinFrequency.setTitle(R.string.pref_min_freq_cpu_big);
            this.mBIGMinFrequency.setDialogTitle(R.string.pref_min_freq_cpu_big);
            this.mBIGMinFrequency.setSummary(R.string.pref_min_freq_cpu_big);
